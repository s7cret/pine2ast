...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--json", default="QUALITY_GATE_LOCAL_v2_14_0.json")
    parser.add_argument("--quality-json", default="QUALITY_GATE_v2_14_0.json")
    parser.add_argument("--builtin-json", default="BUILTIN_COVERAGE_v2_14_0.json")
    parser.add_argument("--test-log", default="TEST_RUN_v2_14_0.log")
    parser.add_argument("--coverage-md", default="COVERAGE_v2_14_0.md")
