...
[![Version](https://img.shields.io/badge/version-4.0.1-blue)](https://github.com/s7cret/pine2ast) [![Python](https://img.shields.io/badge/python-%3E%3D3.11-blue)](https://github.com/s7cret/pine2ast) [![License](https://img.shields.io/badge/license-MIT-green)](https://github.com/s7cret/pine2ast)
...
```bash
python -m pip install 'git+https://github.com/s7cret/pine2ast.git@v4.0.1'
```
